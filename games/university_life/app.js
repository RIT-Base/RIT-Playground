document.addEventListener('DOMContentLoaded', () => {
    ...
    const contentData = [
        ...
        { sem: 1, type: 'card', title: "Sirkel baru", desc:  "Bro, lu jurusan apa? Kantin yuk.", img: "https://placehold.co/600x400/FFD700/333?text=Ambis+Mode", align: "left" },
        { sem: 1, type: 'card', title: "Ujian Pertama", desc: "Belajar H-1, ternyata soalnya esai semua.", img: "https://placehold.co/600x400/FFD700/333?text=Ambis+Mode", align: "center" },        
        ...
        { sem: 2, type: 'card', title: "Matkul Praktikum", desc: "Laporan tulis tangan? Asistensi dicoret-coret? Hal baru deh pokoknya.", img: "https://placehold.co/600x400/3CB371/FFF?text=Lab+Work", align: "left" },
        ...
        { sem: 2, type: 'card', title: "Libur Semester", desc: "Liburnya lama banget, sampai lupa cara nulis.", img: "https://placehold.co/600x400/3CB371/FFF?text=Lab+Work", align: "center" },        
        ...
        { sem: 3, type: 'card', title: "Ujian Lagi", desc: "Perasaan baru kemarin masuk, kok udah UAS?", img: "https://placehold.co/600x400/8B4513/FFF?text=Hectic", align: "center" },       
        ...
        { sem: 4, type: 'card', title: "Event Hunter", desc: "Lomba sana sini, jadi panitia, jadi volunteer... Gas terus selagi muda!", img: "https://placehold.co/600x400/FF8C00/FFF?text=Event+Organizer", align: "left" },
        ...
        { sem: 4, type: 'card', title: "KKN Dimulai", desc: "Keluar dari zona nyaman, 30 hari harus survive seadanya.", img: "https://placehold.co/600x400/556B2F/FFF?text=KKN+Desa", align: "center" },
        ...
        { sem: 5, type: 'card', title: "Berpikir pragmatis", desc: "Nilai ga masalah, yang penting skill.", img: "https://placehold.co/600x400/9400D3/FFF?text=Critical+Thinking", align: "right" },
        { sem: 5, type: 'card', title: "Cuan Oriented", desc: "Ada gak ya aktivitas yang bisa jadi cuan? Mulai freelance/part-time.", img: "https://placehold.co/600x400/006400/FFF?text=Cuan+Hunter", align: "left" },
        { sem: 5, type: 'micro', text: "👔 LinkedIn status: Open to Work", align: "left" },
        { sem: 5, type: 'card', title: "Mulai Sepuh", desc: "Liat maba tingkahnya aneh-aneh. 'Dulu kita gitu gak sih?' (Padahal iya).", img: "https://placehold.co/600x400/778899/FFF?text=Sepuh+Moment", align: "center" },
        ...
        { sem: 6, type: 'card', title: "Jalan Akademisi (Metpen)", desc: "Mulai pusing cari judul skripsi. Ngajuin 3 judul, ditolak semua.", img: "https://placehold.co/600x400/000080/FFF?text=Metpen+Horror", align: "left" },
        { sem: 6, type: 'micro', text: "☕ Kopi bukan lagi hobi, tapi bensin agar tetap hidup.", align: "right" },
        { sem: 6, type: 'card', title: "Realita Magang", desc: "Ekspektasi: Di-mentoring manager. Realita: Disuruh fotocopy & rekap Excel seharian.", img: "https://placehold.co/600x400/2F4F4F/FFF?text=Internship+Life", align: "right" },
        ...
        { sem: 6, type: 'card', title: "Corporate Slave Starter Pack", desc: "Pulang magang, ngerjain laporan harian, tidur 3 jam. Selamat datang di kehidupan dewasa.", img: "https://placehold.co/600x400/191970/FFF?text=The+Hustle", align: "center" },
        ...
        { sem: 7, type: 'card', title: "Seminar Proposal (Sempro)", desc: "Presentasi bab 1-3 dengan tangan dingin. Dosen penguji mulai bertanya hal yang tidak ada di slide.", img: "https://placehold.co/600x400/550000/FFF?text=Deg-degan+Sempro", align: "right" },
        { sem: 7, type: 'card', title: "Laid Back & Lonely", desc: "Ke kampus cuma buat bimbingan. Teman-teman mulai menghilang sibuk sama rutinitasnya masing-masing.", img: "https://placehold.co/600x400/36454F/FFF?text=Lonely", align: "right" },
        { sem: 7, type: 'micro', text: "💍 Liat story IG, Teman angkatan udah mulai nikah", align: "center" }, 
        { sem: 7, type: 'card', title: "Jati Diri", desc: "Quarter Life Crisis. Orang lain udah sukses, aku masih di Bab 1. Scroll LinkedIn malah jadi insecure.", img: "https://placehold.co/600x400/000000/FFF?text=Quarter+Life+Crisis", align: "center" },
        ...
        { sem: 8, type: 'card', title: "Menyelesaikan TA", desc: "Begadang tiap malam di depan laptop. Mata panda permanen, kopi adalah air putih.", img: "https://placehold.co/600x400/FFD700/333?text=Pejuang+Skripsi", align: "right" },
        ...
        { sem: 8, type: 'card', title: "Sidang Skripsi", desc: "Dibantai Penguji, kaki gemetar, otak blank, tapi akhirnya kalimat sakti itu keluar: 'Kamu LULUS'.", img: "https://placehold.co/600x400/B8860B/FFF?text=Sidang", align: "center" },
        { sem: 8, type: 'micro', text: "😭 Nangis haru pas keluar ruang sidang", align: "center" },
        { sem: 8, type: 'card', title: "Hari terakhir di Kosan", desc: "Packing barang. Kamar yang dulu penuh kenangan kini kosong melompong. Pamit sama ibu kos.", img: "https://placehold.co/600x400/696969/FFF?text=Packing+Barang", align: "left" },
        { sem: 8, type: 'card', title: "Wisuda", desc: "Toga, foto keluarga, dan lempar topi. Semua lelah terbayar hari ini. You did it!", img: "https://placehold.co/600x400/FFFFFF/333?text=Wisuda", align: "right" },
        { sem: 8, type: 'micro', text: "👋 Selamat tinggal KTM, selamat datang KTP", align: "right" }, 
        { sem: 8, type: 'card', title: "New Chapter", desc: "Euforia selesai. Dunia kerja menanti. Mengirim CV, menunggu panggilan, dan berjuang lagi dari nol.", img: "https://placehold.co/600x400/F0F8FF/333?text=Welcome+to+Reality", align: "center" },
